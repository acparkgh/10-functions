...
(function () {
  console.log("this function will run only once, now!");
})();

(() => console.log("This function will also run only once, now"))();
...
const boardPassenters = function (numberOfPassengers, waitTime) {
